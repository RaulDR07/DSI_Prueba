...
<li><a href="{{route('deluxe')}}"><span class="glyphicon glyphicon-home"></span>Cabaña 2</a></li>
<li class="active"><a href="{{route('staff')}}"><span class="glyphicon glyphicon-home"></span>Cabaña 1</a></li>
